...
let locationsSection = document.querySelector(
  '.home-page .main-wrapper .locations'
);
let instructorsSection = document.querySelector(
  '.home-page .main-wrapper .instructors'
);
let classesSection = document.querySelector(
  '.home-page .main-wrapper .classes'
);
let posesSection = document.querySelector(
  '.home-page .main-wrapper .yoga-poses'
);
let blogSection = document.querySelector(
  '.home-page .main-wrapper .blog-widget'
);
let followSection = document.querySelector(
  '.home-page .main-wrapper .follow-us'
);
...
let locationToInstructorsTransition = document.querySelector(
  '.locations-to-instructors'
);
...
let locToInstBubbleBackground = document.querySelector(
  '.loc-to-inst-bubble-background'
);
let locToInstBubbleWrap = Snap('.loc-to-inst-bubble-wrap');
let locToInstBubblePath = locToInstBubbleWrap.select('path');
let locToSlideBackground = document.querySelector(
  '.loc-to-inst-slide-background'
);
...
let blogWidgetImageLeft =
  viewportWidth - parseFloat(blogWidgetImageHeight) * 1.2 + 'px';
let blogWidgetImageBottom =
  viewportHeight - parseFloat(blogWidgetImageHeight) + 'px';
...
function initApp() {
  if (window.innerWidth >= 768) {
    ...
    blogWidgetImageLeft =
      viewportWidth - parseFloat(blogWidgetImageHeight) * 1.2 + 'px';
    blogWidgetImageBottom =
      viewportHeight - parseFloat(blogWidgetImageHeight) + 'px';

    if (window.innerWidth <= 991) {
      lottiePath =
        'https://uploads-ssl.webflow.com/649c2309433fb54b2b5ba65c/64cff6576b645b27d64f9c25_yoga-hero-mob.json';
    } else {
      lottiePath =
        'https://uploads-ssl.webflow.com/649c2309433fb54b2b5ba65c/64c903e188a12c56d2150117_yoga-hero-main.json';
    }
...
function resetStates() {
  ...
  let instructors3elements = document.querySelectorAll(
    '.instructors-slide:nth-child(-n+3)'
  );
    ...
    if (window.innerWidth > 768) {
      switch (href) {
        case '/#locations-slider':
          const targetSection1 = document.querySelector(
            `.main-wrapper [scroll-index="2"]`
          );
        ...
        case '/#meet-the-instructors':
          const targetSection2 = document.querySelector(
            `.main-wrapper [scroll-index="3"]`
          );
          ...
          locToInstBubblePath.animate(
            { d: locToInstBubbleNewPath },
            100,
            mina.easeinout
          );
          ...
          break;
        case '/#classes':
          const targetSection3 = document.querySelector(
            `.main-wrapper [scroll-index="4"]`
          );
          ...
          break;
        case '/#yoga-poses':
          const targetSection4 = document.querySelector(
            `.main-wrapper [scroll-index="5"]`
          );
...
const meetTheInstructorsBtn = document.querySelector(
  '#meet-the-instructors-btn'
);
...
function getCurrentBackground() {
  ...
  let currentSlide = document.querySelector(
    '#slider .w-slide:not([aria-hidden="true"])'
  );
  let currentSlideStyle = window.getComputedStyle(currentSlide);
  let currentSlideImageURL = currentSlideStyle.backgroundImage
    .slice(4, -1)
    .replace(/"/g, '');

  locToInstBubbleBackground.style.backgroundImage =
  ...
  if (window.innerWidth > 768) {
    ...
    var currentInsctructorBubble =
      secondVisibleElement.querySelector('.instructors-image');
  } else {
    var secondVisibleElement = document.querySelectorAll(
      ".instructors .w-slide:not([aria-hidden='true'])"
    )[0];
  ...
  let currentInstructorsSlideStyle = window.getComputedStyle(
    currentInsctructorBubble
  );
  let currentInstructorsBackgroundImageURL =
    currentInstructorsSlideStyle.backgroundImage.slice(4, -1).replace(/"/g, '');

  locToSlideBackground.style.backgroundImage =
    'url(' + currentInstructorsBackgroundImageURL + ')';
}
...
function locationsToHero() {
  ...
  gsap.to('.hero-bubble-wrap', {
    maxWidth: originalHeroBubbleWrapWidth,
    duration: 0.6,
  });
  ...
  if (window.innerWidth > 991) {
    gsap.to('.hero-ph-image', {
      width: '40%',
      height: originalHeroHeight,
      duration: 0.6,
    });
  } else {
...
function locationsToInstructors() {
  ...
  gsap.to(locToInstContainer, {
    ...
    onComplete: function () {
      ...
      gsap.to('.instructors-slide:nth-child(1)', {
        delay: 0.2,
        opacity: 1,
        duration: 0.3,
      });
      gsap.to('.instructors-slide:nth-child(3)', {
        delay: 0.2,
        opacity: 1,
        duration: 0.3,
      });
...
function instructorsToClasses() {
  ...
  let currentInstructorsSlideImageURL =
    currentInstructorsSlideStyle.backgroundImage.slice(4, -1).replace(/"/g, '');

  locToSlideBackground.style.backgroundImage =
    'url(' + currentInstructorsSlideImageURL + ')';
...
function posesToBlog() {
  ...
  let yogaToBlogNewPath =
    'M270,224c-53.9,2.8-95.7-0.1-145.6-20.5c-49.6-27.7-59.1-38.1-88.7-80.5C20.9,96.6,13,79.2,0,0h270V224z';
...
function blogToFollow() {
  ...
  let followSvgElement = document.createElementNS(
    'http://www.w3.org/2000/svg',
    'svg'
  );
  followSvgElement.setAttribute('viewBox', '0 0 270 270');
  let followPathElement = document.createElementNS(
    'http://www.w3.org/2000/svg',
    'path'
  );
  followPathElement.setAttribute(
    'd',
    'M1.3,0C13-4.3,259.3-5,270,0c3.3,5.7,7.7,224.1-1.3,224c-119,1.7-156.2-16-209.2-67.2 C26.3,124.7,1.3,52.8,1.3,0z'
  );
  ...
  let distanceToFollowTop =
    followImage.getBoundingClientRect().top -
    followSection.getBoundingClientRect().top +
    'px';
  let distanceToFollowRight =
    followSection.getBoundingClientRect().right -
    followImage.getBoundingClientRect().right +
    'px';
  ...
  let blogToFollowNewPath =
    'M44.1,21.5C98.5-0.9,188.9-10,243.4,15c49.6,22.7,17.9,82.7-9.9,112c-57.5,60.3-156.5,36.3-211.8-16 C-15,76.3,2.6,38.7,44.1,21.5z';
...
function followToBlog() {
  ...
  gsap.to([followHeading, followImages, followSocial], {
    opacity: 0,
    duration: 0.3,
  });
...
function followToFooter() {
  ...
  gsap.to(footerSection, {
    ...
    onComplete: function () {
      ...
      gsap.to([footerHeading, footerRow, footerBottom], {
        opacity: 1,
        duration: 0.3,
      });
    },
...
function footerToFollow() {
  ...
  gsap.to(footerSection, {
    ...
    onComplete: function () {
      ...
      gsap.set([footerSection, footerHeading, footerRow, footerBottom], {
        opacity: '',
      });
    },
  });
